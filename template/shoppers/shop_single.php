...
<html lang="en">
        ...
        <div class="container">
          <div class="row align-items-center">
            ...
            <div class="col-12 mb-3 mb-md-0 col-md-4 order-1 order-md-2 text-center">
              <div class="site-logo">
                <a href="index.html" class="js-logo-clone">WholesaleRockers</a>
              </div>
            </div>
 ...
 <?php
  ...
  $res=mysqli_query($link,"select * from product_details where id=$id ");
  ...
  <div class="site-section">
    <div class="container">
      <div class="row">
        <div class="col-md-6">
          <img src="../admin/<?php echo $row['product_image']; ?>" alt="Image" class="img-fluid">
        </div>
        <div class="col-md-6">
          <h2 class="text-black"><?php echo $row['product_name'] ?></h2>
          <p>  distinctio, aperiam, ratione dolore.</p>
